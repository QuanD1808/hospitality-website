...
function Dashboard({ onNavigate }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            const patients = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPatients"])();
            setPatientCount(patients.length);
            // Calculate new patients added today
            const today = new Date().toISOString().split('T')[0];
            const newPatients = patients.filter({
                "Dashboard.useEffect": (p)=>p.createdAt.startsWith(today)
            }["Dashboard.useEffect"]).length;
            setNewPatientsToday(newPatients);
            // Get waiting queue count
            const waitingQueues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQueuesByStatus"])('waiting');
            setWaitingCount(waitingQueues.length);
            // Get completed queue count for today
            const todayStart = new Date();
            todayStart.setHours(0, 0, 0, 0);
            const completedQueues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQueuesByStatus"])('completed');
            const completedToday = completedQueues.filter({
                "Dashboard.useEffect.completedToday": (q)=>{
                    const queueDate = new Date(q.updatedAt);
                    return queueDate >= todayStart;
                }
            }["Dashboard.useEffect.completedToday"]);
...
_s(Dashboard, "FlsaWhWjhywbMtuq+KKROtUr2U8=", false, function() {
    return [
    ...
    const handleSubmit = (e)=>{
        ...
        try {
            if (isEditing && patient && patient._id) {
                ...
                const updatedPatient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updatePatient"])(patient._id, userData);
                if (updatedPatient) {
                ...
                // Thêm bệnh nhân mới
                const newPatient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addPatient"])(userData);
                if (newPatient) {
...
_s(PatientForm, "veZodLLLr1nRy30IvkE8aQPZzlQ=");
_c = PatientForm;
var _c;
...
function PatientManagement({ onBack }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PatientManagement.useEffect": ()=>{
            ...
            const latestPatients = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPatients"])();
    ...
    const handleDelete = (id)=>{
        ...
        if (confirmed) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deletePatient"])(id);
    ...
    const handleSavePatient = (patientData)=>{
        if (editingPatient && editingPatient._id) {
            // Cập nhật bệnh nhân hiện có
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updatePatient"])(editingPatient._id, patientData);
        } else {
            // Thêm bệnh nhân mới
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addPatient"])({
                ...patientData,
                role: 'PATIENT'
            });
        }
    ...
    const addToWaitingRoom = (patientId)=>{
        ...
        const existingQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQueueByPatientId"])(patientId);
        if (existingQueue) {
            if (existingQueue.status === 'waiting' || existingQueue.status === 'in_progress') {
                ...
                const newQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addQueue"])(patientId);
                if (newQueue) {
    ...
    const filteredPatients = searchTerm.trim() === '' ? patients : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchUsers"])(searchTerm).filter((user)=>user.role === 'PATIENT');
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(PatientManagement, "dRk8bkkIjLAsRTt/x8Q7QPaXnEU=");
...
function QueueManagement({ onBack }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QueueManagement.useEffect": ()=>{
            ...
            const allQueues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllQueuesWithPatientInfo"])();
            setQueues(allQueues);
            // Lọc ra các trạng thái khác nhau
            const waiting = allQueues.filter({
                "QueueManagement.useEffect.waiting": (q)=>q.status === 'waiting'
            }["QueueManagement.useEffect.waiting"]);
            const inProgress = allQueues.filter({
                "QueueManagement.useEffect.inProgress": (q)=>q.status === 'in_progress'
            }["QueueManagement.useEffect.inProgress"]);
            setWaitingPatients(waiting);
            setInProgressPatients(inProgress);
            // Lấy danh sách bác sĩ
            const allDoctors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllDoctors"])();
    ...
    const handleConfirmMoveToExamination = (doctorId)=>{
        ...
        const updatedQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateQueueStatus"])(selectedQueue, 'in_progress', doctorId);
        if (updatedQueue) {
    ...
    const handleCompleteExamination = (queueId)=>{
        ...
        const updatedQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateQueueStatus"])(queueId, 'completed');
        if (updatedQueue) {
            // Cập nhật lại state để re-render UI
            const allQueues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllQueuesWithPatientInfo"])();
            setQueues(allQueues);
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            waitingPatients.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: waitingPatients.map((queue, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            inProgressPatients.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "divide-y divide-gray-200",
            ...
            showDoctorModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        doctors.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(QueueManagement, "21NWAw/Rm+QMicCK5v3nYpZWIdw=");
_c = QueueManagement;
var _c;
...
function MedicationHistory({ onBack }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MedicationHistory.useEffect": ()=>{
            ...
            const prescriptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPrescriptions"])();
            // Transform prescriptions to the format we need for display
            const records = prescriptions.map({
                "MedicationHistory.useEffect.records": (prescription)=>{
                    // Get patient info
                    ...
                    const medications = prescriptionDetails.map({
                        "MedicationHistory.useEffect.records.medications": (detail)=>{
                    ...
                    }["MedicationHistory.useEffect.records.medications"]);
            ...
            }["MedicationHistory.useEffect.records"]);
...
function AppointmentForm({ onClose }) {
    ...
    const patients = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPatients"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppointmentForm.useEffect": ()=>{
            if (searchTerm.length > 0) {
                ...
                const results = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchUsers"])(searchTerm).filter({
                    "AppointmentForm.useEffect.results": (user)=>user.role === 'PATIENT'
                }["AppointmentForm.useEffect.results"]);
    ...
    const handleSubmit = (e)=>{
        ...
        const newQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addQueue"])(formData.patientId, status);
        if (newQueue) {
...
_s(AppointmentForm, "DB9KjuP+U6Sc3wkPiq1Xq1BK/LI=");
_c = AppointmentForm;
var _c;
...
function AppointmentBooking({ onBack }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppointmentBooking.useEffect": ()=>{
            ...
            const mockAppointments = patients.slice(0, 5).map({
                "AppointmentBooking.useEffect.mockAppointments": (patient, index)=>{
            ...
            }["AppointmentBooking.useEffect.mockAppointments"]);
    ...
    const handleMoveToQueue = (appointmentId)=>{
        ...
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addQueue"])(appointmentId, 'waiting');
        if (result) {
...
_s(AppointmentBooking, "5lcpkMKvlOFFpItAyGWBShtGuQU=");
...
//# sourceMappingURL=src_app_8f1d6cd3._.js.map