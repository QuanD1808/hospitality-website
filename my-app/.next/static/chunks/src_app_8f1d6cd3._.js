...
function PatientForm(param) {
    let { patient, onClose, onSave, isLoading = false } = param;
    _s();
    ...
    const updatePatient = (id, patientData)=>{
        try {
            ...
            console.log("Using mock function to update patient with ID ".concat(id, ":"), updatedPatient);
            return updatedPatient;
        } catch (error) {
            console.error("Error in mock updatePatient for ".concat(id, ":"), error);
            return null;
        }
    };
            ...
            if (isEditing && patient && patient._id) {
                ...
                if (token) {
                    try {
                        ...
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"](patient._id, userData, token);
                        ...
                        if (apiError.response) {
                            if (apiError.response.data && apiError.response.data.field) {
                                ...
                                setFieldErrors({
                                    [fieldName]: apiError.response.data.message || "Lỗi với trường ".concat(fieldName)
                                });
                            } else {
                                var _apiError_response_data;
                                setError("Lỗi từ server: ".concat(((_apiError_response_data = apiError.response.data) === null || _apiError_response_data === void 0 ? void 0 : _apiError_response_data.message) || apiError.message));
                            }
                        } else {
                            setError("Lỗi kết nối: ".concat(apiError.message));
                        }
                ...
                if (resultPatient) {
                    setSuccessMessage("Đã cập nhật thông tin bệnh nhân: ".concat(resultPatient.fullName));
                } else {
                ...
                if (token) {
                    try {
                        ...
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUser"](userData, token);
                        resultPatient = response;
                        ...
                        if (apiError.response) {
                            ...
                            if (apiError.response.data && apiError.response.data.field) {
                                ...
                                setError("Lỗi từ server: ".concat(((_apiError_response_data1 = apiError.response.data) === null || _apiError_response_data1 === void 0 ? void 0 : _apiError_response_data1.message) || apiError.message));
                            }
                ...
                if (resultPatient) {
                    setSuccessMessage("Đã thêm bệnh nhân mới: ".concat(resultPatient.fullName, " (ID: ").concat(resultPatient.userId, ")"));
                ...
                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "w-full border ".concat(fieldErrors.fullName ? 'border-red-500' : 'border-gray-300', " rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-black shadow-sm"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "w-full border ".concat(fieldErrors.userId ? 'border-red-500' : 'border-gray-300', " rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-black shadow-sm"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "w-full border ".concat(fieldErrors.username ? 'border-red-500' : 'border-gray-300', " rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-black shadow-sm"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "w-full border ".concat(fieldErrors.email ? 'border-red-500' : 'border-gray-300', " rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-black shadow-sm"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "w-full border ".concat(fieldErrors.phone ? 'border-red-500' : 'border-gray-300', " rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-black shadow-sm"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "w-full border ".concat(fieldErrors.password ? 'border-red-500' : 'border-gray-300', " rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-black shadow-sm"),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "submit",
                                className: "px-5 py-2 rounded-lg text-white font-medium transition-colors flex items-center shadow-sm ".concat(loading ? 'bg-green-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'),
                                disabled: loading,
...
_s(PatientForm, "fxcqA0TC+tOHDenkZo3I13Cq7Os=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
                ...
                "PatientManagement.useEffect.loadData": async ()=>{
                    ...
                    try {
                        ...
                        const validPatients = patientData.filter({
                            "PatientManagement.useEffect.loadData.validPatients": (patient)=>patient !== null && patient !== undefined
                ...
                "PatientManagement.useEffect.handleSearch": async ()=>{
                    ...
                    try {
                        ...
                        setSearchResults(results.filter({
                            "PatientManagement.useEffect.handleSearch": (user)=>user && user.role === 'PATIENT'
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-6",
                        children: [
                            sortedPatients && sortedPatients.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
