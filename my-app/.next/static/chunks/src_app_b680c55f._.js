        ...
        "AppointmentForm.useEffect": ()=>{
            if (searchTerm.length > 0) {
                const results = mockPatients.filter({
                    "AppointmentForm.useEffect.results": (patient)=>patient.name.toLowerCase().includes(searchTerm.toLowerCase()) || patient.nationalId.includes(searchTerm) || patient.phone.includes(searchTerm)
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        name: "password",
                                        required: !patient,
                                        placeholder: patient ? "Để trống nếu không thay đổi..." : "Nhập mật khẩu...",
                                        className: "w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-black shadow-sm",
...
_s(PatientForm, "VkzPeaYM5mG8lHKYsuSwo8exsVI=");
_c = PatientForm;
var _c;
...
function PatientManagement({ onBack }) {
    ...
    // Sử dụng dữ liệu bệnh nhân từ mockPatients.ts - đã được lọc theo role='PATIENT'
...
_s(PatientManagement, "gDWbdabh8kffvXB2clEgNR6dnwY=");
...
//# sourceMappingURL=src_app_b680c55f._.js.map