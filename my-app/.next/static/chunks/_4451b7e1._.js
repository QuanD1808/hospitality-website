...
const PatientCard = ({ patient, isSelected, onSelect })=>{
    ...
    const [waitingTime, setWaitingTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "PatientCard.useState": ()=>Math.floor((new Date().getTime() - new Date(patient.checkInTime).getTime()) / 60000)
...
_s(PatientCard, "0RwHf5aqZc9m3RshCgM9aetE8Es=");
_c = PatientCard;
var _c;
...
const MedicineEntry = ({ medicine, onUpdate, onRemove })=>{
    ...
    const [totalPills, setTotalPills] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(medicine.dosage || '0');
    const [schedule, setSchedule] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(medicine.frequency || '');
    const handleChange = ()=>{
        onUpdate({
            ...medicine,
            name,
...
_s(MedicineEntry, "nKP4bx5SNy83nxEYl+0nfI4SxV4=");
_c = MedicineEntry;
var _c;
...
const DiagnosisPanel = ({ patient, onMarkAsDone })=>{
    _s();
    const [diagnosis, setDiagnosis] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(patient?.diagnosis || '');
    const [prescription, setPrescription] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Array.isArray(patient?.prescription) ? patient?.prescription : []);
...
_s(DiagnosisPanel, "bUmeLiPvjAb96o0uQOhTzTR40SI=");
_c = DiagnosisPanel;
var _c;
...
"[project]/src/app/datats/auth.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/datats/auth.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const Dashboard = ()=>{
    _s();
    const [patients, setPatients] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPatients"]);
...
_s(Dashboard, "jyurCmAemnlErUsY+C2y0k+9dHQ=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=_4451b7e1._.js.map