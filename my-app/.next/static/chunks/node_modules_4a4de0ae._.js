...
class JSAnimation extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$animation$2f$utils$2f$WithPromise$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WithPromise"] {
    ...
    constructor(options){
         ...
         */ this.stop = function() {
            let sync = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
            var _this_options_onStop, _this_options;
            if (sync) {
                const { motionValue } = _this.options;
...
function supportsBrowserAnimation(options) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$utils$2f$is$2d$html$2d$element$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHTMLElement"])(motionValue === null || motionValue === void 0 ? void 0 : (_motionValue_owner = motionValue.owner) === null || _motionValue_owner === void 0 ? void 0 : _motionValue_owner.current)) {
        return false;
    }
...
function createProjectionNode(param) {
    ...
    return class ProjectionNode {
        ...
        startAnimation(options) {
            ...
            (_this_currentAnimation = this.currentAnimation) === null || _this_currentAnimation === void 0 ? void 0 : _this_currentAnimation.stop(false);
            (_this_resumingFrom = this.resumingFrom) === null || _this_resumingFrom === void 0 ? void 0 : (_this_resumingFrom_currentAnimation = _this_resumingFrom.currentAnimation) === null || _this_resumingFrom_currentAnimation === void 0 ? void 0 : _this_resumingFrom_currentAnimation.stop(false);
        ...
        getProjectionStyles(styleProp) {
            ...
            if (lead.animationValues) {
                 ...
                 * opacity
                 */ styles.opacity = lead === this ? (_ref = (_valuesToRender_opacity = valuesToRender.opacity) !== null && _valuesToRender_opacity !== void 0 ? _valuesToRender_opacity : this.latestValues.opacity) !== null && _ref !== void 0 ? _ref : 1 : this.preserveOpacity ? this.latestValues.opacity : valuesToRender.opacityExit;
            } else {
                /**
        ...
        resetTree() {
            this.root.nodes.forEach((node)=>{
                ...
                return (_node_currentAnimation = node.currentAnimation) === null || _node_currentAnimation === void 0 ? void 0 : _node_currentAnimation.stop(false);
            });
...
//# sourceMappingURL=node_modules_4a4de0ae._.js.map