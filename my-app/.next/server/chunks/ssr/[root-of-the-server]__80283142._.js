...
const fetchPatientsWithPrescriptions = async ()=>{
    ...
    try {
        ...
        const apiPromise = new Promise(async (resolve, reject)=>{
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticatedGet"])('/prescriptions/status/PENDING_DISPENSE');
        ...
        const prescriptions = await Promise.race([
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockPrescriptions"].filter((p)=>p.status.toUpperCase() === 'PENDING_DISPENSE');
        });
        // Log the result
        ...
        const patients = await Promise.all(prescriptions.map(async (prescription)=>{
            try {
                ...
                const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u._id === prescription.patientId) || await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticatedGet"])(`/users/${prescription.patientId}`);
                if (!user) {
                ...
                try {
                    ...
                    const apiDetails = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticatedGet"])(`/prescriptionDetails/prescription/${prescription._id}`);
                    if (apiDetails && Array.isArray(apiDetails) && apiDetails.length > 0) {
                        ...
                        details = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockPrescriptionDetails"].filter((d)=>d.prescriptionId === prescription._id);
                    }
                } catch (error) {
                ...
                const augmentedDetails = details.map((detail)=>{
                    const medicine = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockMedicines"].find((m)=>m._id === detail.medicineId);
                    return {
                        ...detail,
