...
const getPatientsWithPendingPrescriptions = ()=>{
    // Get all prescriptions with status PENDING_DISPENSE
    ...
    if (!pendingPrescriptions.length) return [];
    // Map prescriptions to pharmacy patient format
    return pendingPrescriptions.map((prescription, index)=>{
        ...
        // Map medicines to pharmacy medicine format
        const pharmacyMedicines = prescriptionDetails.map((detail)=>{
        ...
        return {
            id: patient._id,
            serialNumber: prescription.customPrescriptionId || `P${index + 1}`,
            fullName: patient.fullName,
            phone: patient.phone,
            diagnosis: prescription.diagnosis,
            doctor: doctor ? doctor.fullName : 'Không xác định',
            prescription: pharmacyMedicines
        };
    }).filter(Boolean);
};
const getPharmacyInvoices = ()=>{
    const invoices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllInvoices"])();
    const pharmacistId = '685face13fc4c04e1bd96c0a'; // ID của dược sĩ Phạm Văn Dũng
    return invoices.map((invoice)=>{
        const pharmacist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserById"])(pharmacistId);
        return {
            id: invoice._id,
            date: invoice.createdAt,
            patientId: invoice.patientId,
            pharmacistName: pharmacist ? pharmacist.fullName : 'Nguyễn Thị Hà',
...
const Dashboard = ({ user, onLogout })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const patients = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$pharmacyPage$2f$pharmacyUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPatientsWithPendingPrescriptions"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__421dce49._.js.map