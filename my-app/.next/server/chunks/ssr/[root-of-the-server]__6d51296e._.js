...
const Invoice = ({ patient, onClose, onComplete })=>{
    const { token, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])(); // Get both token and user from auth context
                    ...
                    try {
                        ...
                        for (const detail of prescriptionDetails){
                            ...
                            try {
                                ...
                                const medicine = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMedicineById"])(medicineId, tokenFromStorage);
                                medicines.push({
                                ...
                                const medicineId = extractMedicineId(detail.medicineId);
                                const mockMedicine = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMedicineById"])(medicineId);
                                medicines.push({
        ...
        try {
            ...
            for (const detail of prescriptionDetails){
                try {
                    ...
                    const medicine = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$datats$2f$mockPatients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMedicineById"])(medicineId);
                    if (!medicine) {
...
const Dashboard = ({ user, onLogout })=>{
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('dispense'); // Only 'dispense' tab remains
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d51296e._.js.map